...
namespace ThyroCareX.Infrastructure.Migrations
{
    ...
    [Migration("20260701194636_AddGeneralAiSessionTables")]
    partial class AddGeneralAiSessionTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.AgentChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.AgentSession", b =>
                {
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.DiagnosisResult", b =>
                {
                    ...
                    b.Property<string>("FnacRawResponse")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.GeneralAiChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GeneralAiChatMessages");
                });

            modelBuilder.Entity("ThyroCareX.Data.Models.GeneralAiSession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.AgentChatMessage", b =>
                {
                    b.HasOne("ThyroCareX.Data.Models.AgentSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("ThyroCareX.Data.Models.GeneralAiChatMessage", b =>
                {
                    b.HasOne("ThyroCareX.Data.Models.GeneralAiSession", "Session")
                        .WithMany("Messages")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
